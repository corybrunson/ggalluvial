...
**ggalluvial** parameters and existing **ggplot2** functionality can also produce [parallel sets](https://eagereyes.org/parallel-sets), illustrated here using the `Titanic` dataset:[^ggparallel]
