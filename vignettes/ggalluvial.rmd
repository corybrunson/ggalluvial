...
- The `label.strata` parameter must instruct `stat_stratum()` (called by `geom_text()`) to take the values of the axis variables as labels because the labels cannot be found in any single column of the input dataset, so cannot be assigned to as aesthetic.
